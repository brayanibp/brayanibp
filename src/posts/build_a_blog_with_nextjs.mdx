...
<SyntaxHighlighter language="bash" style="dracula">
{`npm install @next/mdx @mdx-js/loader @mdx-js/react gray-matter rehype-highlight remark-gfm`}
</SyntaxHighlighter>

Now, create the MDX configuration file:
...
Create a utility file to handle MDX files:
...
## Step 9: Generate Dynamic Sitemap
...
export async function sendNotification(post: {
  ...
  await resend.emails.send({
    ...
    html: \`
      ...
      <a href="https://yourblog.com/blog/\${post.slug}">Read more</a>
    \`,
  });
}`}
</SyntaxHighlighter>

## Step 13: Add Security Middlewares
